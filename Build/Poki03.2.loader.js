  ...
  var o,
    l = {
      ...
      locateFile: function(e) {
        return "build.wasm" == e ?
          "https://pub-2d868f15a1824cc8a2ec51069ed41c6f.r2.dev/golf_orbit_aea9a879728b451553b7377ede5ae537.wasm.br" :
          e;
      },
            ...
            if (l.frameworkUrl.endsWith("." + r[0]))
              return (
                ...
                ((n +=
                  ...
                  ((r = -1 != ["localhost", "127.0.0.1"].indexOf(location.hostname) ?
                      "" :
      ...
      l.addRunDependency("dataUrl"),
        o.then(function(e) {
          ...
          for (n += 4; n < o;) {
            ...
            n += s;
            for (
              var u = 0, d = c.indexOf("/", u) + 1; 0 < d; u = d, d = c.indexOf("/", u) + 1
            )
          ...
          return void 0 === e ?
            ...
            e.read().then(function(e) {
              if (e.done) {
                ...
                for (
                  var t = new Uint8Array(h), n = (t.set(d, 0), f), r = 0; r < l.length;
                  ++r
                )
      ...
      ((f = {
                ...
                function(t, n) {
                  try {
                    ...
                    null === this.database ?
                      ...
                      ((e = -1 != ["put", "delete", "clear"].indexOf(i) ?
                          "readwrite" :
                          "readonly"),
        ...
        (x.prototype.cleanUpCache = function() {
          ...
          return this.getMetaDataEntries().then(function(e) {
            for (
              var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length;
              ++a
            )
